; Calculate surface area and volume of square pyramids
...
; calculate volume lateral and surface
...
; total area = a-side * (2 * a-side * s-side)
...
statsLoop:
    ...
    cmp     eax, dword [taMin]
    jae     notNewTaMin
    mov     dword [taMin], eax  ; save new min surface
